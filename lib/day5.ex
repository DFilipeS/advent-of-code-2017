defmodule AdventOfCode2017.Day5 do
  @moduledoc """
  Module for the problem for Day 5 of Advent Of Code 2017.
  """
  ...
  ## Examples
      ...
      iex> AdventOfCode2017.Day5.steps_to_exit([0, 3, 0, 1, -3])
      5

  """
  @spec steps_to_exit(list(integer())) :: integer()
  ...
  ## Examples
      ...
      iex> AdventOfCode2017.Day5.steps_to_exit_stranger([0, 3, 0, 1, -3])
      10

  """
  @spec steps_to_exit_stranger(list(integer())) :: integer()
