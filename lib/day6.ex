defmodule AdventOfCode2017.Day6 do
  @moduledoc """
  Module for the problem for Day 6 of Advent Of Code 2017.
  """
  ...
  ## Examples
      ...
      iex> AdventOfCode2017.Day6.find_cycle([0, 2, 7, 0])
      5

  """
  @spec find_cycle(list(integer())) :: integer()
  ...
  @doc """
  Find the size of the period of the first detected cycle.

  ## Examples

      iex> AdventOfCode2017.Day6.find_cycle_period([0, 2, 7, 0])
      4

  """
  @spec find_cycle_period(list(integer())) :: integer()
